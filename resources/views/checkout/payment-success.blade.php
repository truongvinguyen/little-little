                ...
                <div class="article-main py-1">
                    <div class="container">
                        <div class="article-middle-bg-1 p-1 my-3">
                            <div class="article-middle-dashed-1" style="padding: 1.5rem 0 0.5rem">
                                <img class="article-middle-5" src="/img/Alvin_Arnold_Votay1 1.png" alt="">
                                <div class="slider" id="slider">
                                    <div class="slide" id="slide">
                                
                                        <div class="col-sm-10 mx-auto d-flex">
                                            <div class="col-sm-1 mx-2" style="margin-left: -3% !important;">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220501</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                                        
                                                        <h2 class= "--- text-dark mx-auto">---</h2>
                                                        <p class="text-dark">Ngày sử dụng 30/05/2022</p>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220502</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220503</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220504</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                        ...
                                        <div class="col-sm-10 mx-auto d-flex">
                                            <div class="col-sm-1 mx-2" style="margin-left: -3% !important;">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220505</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220506</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220507</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220508</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                        ...
                                        <div class="col-sm-10 mx-auto d-flex">
                                            <div class="col-sm-1 mx-2" style="margin-left: -3% !important;">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT20220509</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT202205010</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT202205011</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                            ...
                                            <div class="col-sm-1 mx-2">
                                                <div class="card" style="border-radius: 25px;">
                                                    <img class="qr" src="/img/QR.svg" alt="">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-center text-dark">ALT202205012</h4>
                                                        <h6 class="card-title text-center text-warning text-uppercase mt-2">vé cổng</h6>
                                        ...
                                        <div class="col-sm-11 mx-auto d-flex">
                                            <div class="col-sm-6" style="margin-top: 1rem;">
                                                <p class="text-dark text-capitalize">số lượng 12 vé</p>
                                            </div>
                                            <div class="col-sm-6" style="margin-top: 1rem;">
                                                <span class="text-dark text-capitalize" style="float: right;">trang 3/3</span>
                                            </div>
                                        </div>
                                    </div> 
